...
public class LobbyManager : MonoBehaviourPunCallbacks
{
    ...
    public void SetPlayerNum2()
    {
        ...
        SelectImage.transform.position = new Vector3(-29,5,0);
    ...
    public void SetPlayerNum3()
    {
        playerNumber = 3;
        //SelectImage.SetActive(true);
        SelectImage.transform.position = new Vector3(-6, 5, 0);
        MakeRoomBtn.interactable = true;
    }
    ...
    public void SetPlayerNum4()
    {
        playerNumber = 4;
        //SelectImage.SetActive(true);
        SelectImage.transform.position = new Vector3(18, 5, 0);
        MakeRoomBtn.interactable = true;
    }
    ...
    public static void SetWinPro(bool bo)
    {
        ...
        // snake에서 ActorNumber-1을 인자로 받아서 이렇게 배열로 하는게 맞는지 윗줄처럼 LocalPlayer하는게 맞는지..
